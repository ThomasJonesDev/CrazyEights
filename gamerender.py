...
class GameRenderer:
    ...
    def __init__(self) -> None:
        ...
        self._back_of_card_image: 'Surface' = image.load('images/Playing Cards/card-back1.png')
    ...
    def draw_player_one_cards(self, playing_hand: list['Card']) -> None:
        for index in range(len(playing_hand)):
            self._display.blit(playing_hand[index].get_card_image(), (320 + (index * 100), 800))
    ...
    def render(
            self, game_deck: 'Deck', game_pile: 'Pile',
            player_one: 'Player', player_two: 'Player') -> None:
