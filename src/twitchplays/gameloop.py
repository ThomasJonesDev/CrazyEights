...
class GameLoop:
    ...
    def twitch__chat_move(self) -> None:
        ...
        if (
            ...
            self.game_state = CurrentPlayer.AI_PLAYING

    def _pick_up_cards(self, player: Player) -> None:
        while (
