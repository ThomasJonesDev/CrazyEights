...
def game_loop():
    ...
    while not game_over:
        ...
        if game_state is GameState.TWITCH_PLAYING:
            ...
            if CrazyEights.check_if_any_valid_moves(twitch_player.get_player_hand(), pile.get_top_card()) is False:
                twitch_player.add_card_to_hand(deck.draw_card())
            ...
            if countdown.is_countdown_running() is True and countdown.get_countdown_in_seconds() <= 0:
                ...
                if twitch_player.get_how_many_cards_player_has() == 0:
                    ...
                    print('Twitch Player wins')  # TODO change this to a win message using render class
                    break
